    ...
    return (
        <div className="bg-white lg:px-20">
            <div className="pt-6">
                ...
                <section className='grid grid-cols1 lg:grid-cols-2 gap-x-8 gap-y-10 px-4 pt-10'>
                    {/* Image gallery */}
                    <div className="flex flex-col items-center">
                        ...
                        <div className="flex flex-wrap space-x-5 justify-center">
                            {product.images.map((items)=> <div className="aspect-h-2 aspect-w-3 overflow-hidden rounded-lg max-w-[5rem] max-h-[5rem] mt-4">
                                <img
                                    alt={items.src}
                                    src={items.src}
                                    className="h-full w-full object-cover object-center"
                    ...
                    <div className="lg:col-span-1 maxt-auto max-w-2xl px-4 pb-16 sm:px-6 lg:max-w-7xl lg:px-8 lg:pb-24">
                        <div className="lg:col-span-2">
                            <h1 className="text-lg lg:text-xl font-semibold text-gray-900">Title Of the Product</h1>
                            <h1 className='text-lg lg:text-xl text-gray-900 opacity-60 pt-1'>Brand Name</h1>
                        </div>
                        ...
                        <Grid container spacing={7}>
                            ...
                            <Grid item xs={5}>
                                ...
                                <div className='flex item-center space-x-3'>
                                    ...
                                    <p className='opacity-60'>54355 Ratings</p>
                                </div>
                                <Box className="mt-5 space-y-3">
                                    ...
                                    <Grid container alignItems="center" gap={2}>
                                        ...
                                        <Grid item xs={7}>
                                            <LinearProgress sx={{bgcolor:"#d0d0d0",borderRadius:4,height:7}} variant="determinate" value={30}     className="bg-yellow-800"/>
                                        </Grid>
                                    </Grid>
                                    {/* 4 */}
                                    <Grid container alignItems="center" gap={2}>
